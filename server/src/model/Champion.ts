...
export const PlaystyleInfoSchema = z
	.object({
		damage: z.number(),
		durability: z.number(),
...
export const DescriptionInfoSchema = z
	.object({
		title: z.string(),
		description: z.string(),
		iconPath: z.string(),
...
export const SkinFeaturePreviewDatumSchema = z
	.object({
		description: z.string(),
		iconPath: z.string(),
		videoPath: z.string(),
...
export const TacticalInfoSchema = z
	.object({
		style: z.number(),
		difficulty: z.number(),
		damageType: z.string(),
...
export const SkinAugmentsSchema = z
	.object({
...
export const QuestSkinInfoSchema = z
	.object({
		name: z.string(),
